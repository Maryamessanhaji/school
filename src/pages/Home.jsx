      ...
      <div className="relative container mx-auto flex flex-col items-center justify-center text-center h-full px-4">
        <div className="text-right max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-amber-400 hover:bg-[#cfc85a] text-black py-3 px-6 rounded-lg text-lg font-semibold">
              ابدأ الآن
            </button>
            <button className="bg-amber-300 hover:bg-[#cfc85a] text-black py-3 px-6 rounded-lg text-lg font-semibold">
              المزيد من المعلومات
            </button>
          </div>
        </div>
